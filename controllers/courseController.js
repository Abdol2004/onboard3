...
exports.getAvailableCourses = async (req, res) => {
  try {
    const courses = [
      ...
      {
  id: 'web3-survival-course',
  name: 'Web3 Survival Course',
  description: 'A beginner-friendly crash course that teaches you everything you need to navigate Web3 safely, avoid scams, use wallets, join communities, and become a confident Web3 citizen.',
  duration: '4 weeks',
  level: 'Beginner',
  skills: [
    'Crypto Wallet Setup',
    ...
    'Airdrop Basics',
    'Chain Navigation (Solana, Base, Ethereum)',
    'Using DEXs',
    'Community Navigation',
    'Basic On-chain Tasks'
  ],
  icon: 'fa-shield-alt'
}
    ];
